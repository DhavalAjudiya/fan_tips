                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            Get.toNamed(NewsDetailedScreen.routeName,
                                arguments: {
                                  "image": homeController
                                      .newsModel.value.news?[0].image,
                                  "title": homeController
                                      .newsModel.value.news?[0].title,
                                  "subtitle": homeController
                                      .newsModel.value.news?[0].smallDesc,
                                  "time": homeController.timeAgo(
                                      homeController.data(homeController
                                          .newsModel.value.news?[0].time)),
                                });
                          },
                          height: 20.h,
                        ...
                        CustomeText(
                          title:
                              "${homeController.newsModel.value.news?[0].title}",
                          fontSize: 11.sp,
                          ...
                          child: Obx(() {
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return homeController.newsPagination.length -
                                            1 ==
                                        index
                                    ? Padding(
