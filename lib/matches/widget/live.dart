        ...
        Expanded(
          child: Obx(
            () => ListView.builder(
              ...
              itemCount: _homecontroller.liveMatches.value.matches?.started?.length,
              itemBuilder: (context, index) {
                final current = _homecontroller.liveMatches.value.matches?.started?[index];
                ...
                return Obx(
                  () => GestureDetector(
                    ...
                    child: CustomLCContainer(
                      ...
                      icon: current?.isSelected.value == false ? const Icon(Icons.notifications) : const Icon(Icons.notifications_none),
