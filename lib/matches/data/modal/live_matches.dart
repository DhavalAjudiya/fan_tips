...
//
//     final liveMatches = liveMatchesFromJson(jsonString);

import 'dart:convert';

import 'package:get/get_rx/src/rx_types/rx_types.dart';

LiveMatches liveMatchesFromJson(String str) =>
    LiveMatches.fromJson(json.decode(str));
...
class LiveMatches {
  ...
  factory LiveMatches.fromJson(Map<String, dynamic> json) => LiveMatches(
        result: json["result"],
...
class Matches {
  ...
  factory Matches.fromJson(Map<String, dynamic> json) => Matches(
        started:
            List<Started>.from(json["STARTED"].map((x) => Started.fromJson(x))),
      );
