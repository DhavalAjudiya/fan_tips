...
PredictionModal predictionModalFromJson(String str) =>
    PredictionModal.fromJson(json.decode(str));

String predictionModalToJson(PredictionModal data) =>
...
class PredictionModal {
  ...
  factory PredictionModal.fromJson(Map<String, dynamic> json) =>
      PredictionModal(
        result: json["result"],
